...
class Candidate(Base):
    ...
    hr_assistant_screen_score = Column(String(100), nullable=True)
    hr_assistant_result = Column(Text, nullable=True)
    hr_assistant_reason_result = Column(Text, nullable=True)
    hr_assistant_transcript = Column(Text, nullable=True)
...
class CandidateCreate(BaseModel):
    ...
    status: str
    hr_assistant_screen_score: str
    hr_assistant_result: str
    hr_assistant_reason_result: str
    hr_assistant_transcript: str
